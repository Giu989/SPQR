...
Options[solveSystem] = {"MonomialOrder" -> Lexicographic, "IrreducibleMonomials"->{},"EliminateVariables"->{{},0},"PrintDebugInfo"->0};
(**)
solveSystem[targets_,ideal_,variables_,maxWeight_,OptionsPattern[]]:= Module[
	{
...
Options[reconstructSystemOutput] = {"Vector" -> False};
reconstructSystemOutput[output_List,OptionsPattern[]]:=Module[{reconstructed,ans},
