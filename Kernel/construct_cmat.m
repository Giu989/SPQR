...
Options[constructCompanionMatrices] = {"MonomialOrder" -> Lexicographic,"PrintDebugInfo"->0};
constructCompanionMatrices[ideal_,variables_,maxWeight_,irreducibleMonomials_,OptionsPattern[]]:=Module[
	{
	cmatsMonomials,solverOutput,cpmatrixNames,takePatternLists
	}
	,
	cmatsMonomials = Outer[#*irreducibleMonomials&,variables]//Flatten;
	solverOutput = solveSystem[cmatsMonomials,ideal,variables,maxWeight,"IrreducibleMonomials"->irreducibleMonomials,"MonomialOrder"->OptionValue["MonomialOrder"],"PrintDebugInfo"->OptionValue["PrintDebugInfo"]];
