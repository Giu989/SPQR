...
constructTargetCmat[target_,cmatOutput_]:=Module[
...
Options[ffPolyDiv] = {"cmat"->False,"DeleteGraph"->True,"Vector"->False};
ffPolyDiv[targetOutput_,irredMons_,OptionsPattern[]]:=Module[
...
ffPolyDiv[targetOutput_]:=ffPolyDiv[targetOutput,{},"cmat"->True];
